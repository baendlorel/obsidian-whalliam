  ...
  children: [
    {
      tag: 'g',
      attributes: {
        class: 'whalliam-provider-icon-variant whalliam-provider-icon-variant--light',
    ...
    },
    {
      tag: 'g',
      attributes: {
        class: 'whalliam-provider-icon-variant whalliam-provider-icon-variant--dark',
        transform: 'translate(30 0)',
      },
      children: [
...
export function createProviderIconSvg(
  ...
  svg.classList.add('whalliam-provider-icon');
