...
export class ProviderRegistry {
  ...
  static createTitleGenerationService(plugin: WhalliamPlugin, providerId?: ProviderId): TitleGenerationService {
    if (!providerId) {
  ...
  static createInstructionRefineService(plugin: WhalliamPlugin, providerId: ProviderId = DEFAULT_CHAT_PROVIDER_ID): InstructionRefineService {
    return this.getProviderRegistration(providerId).createInstructionRefineService(plugin);
  }

  static createInlineEditService(plugin: WhalliamPlugin, providerId: ProviderId = DEFAULT_CHAT_PROVIDER_ID): InlineEditService {
...
class RoutedTitleGenerationService implements TitleGenerationService {
  ...
  constructor(private readonly plugin: WhalliamPlugin) {}
