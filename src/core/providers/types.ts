...
export const DEFAULT_CHAT_PROVIDER_ID = 'codewhale' as const satisfies ProviderId;
...
export interface ProviderRegistration {
  ...
  createTitleGenerationService: (plugin: WhalliamPlugin) => TitleGenerationService;
  createInstructionRefineService: (plugin: WhalliamPlugin) => InstructionRefineService;
  createInlineEditService: (plugin: WhalliamPlugin) => InlineEditService;
